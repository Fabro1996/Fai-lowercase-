        ...
        raw1 = call_claude([
            {
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": """Analyze this engineering drawing for First Article Inspection. Extract ALL characteristics.
  ...
  "characteristics": [
    {
      ...
      "nominal": "34.93",
      "unit": "mm",
      "tolerance": "per title block",
      "view": "front",
      "priority": "standard"
    }
  ]
}
Replace the example with ALL real characteristics.
Extract every visible dimension, diameter, radius, angle, material, finish, surface roughness, and note."""
                    },
                ],
            }
        ])
