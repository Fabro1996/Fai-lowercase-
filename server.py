...
HOW TO MATCH:
1. First determine which view region the balloon is in using the layout above
2. Narrow the candidate characteristics to those that belong in that view
3. Find the dimension callout, leader line, or annotation at or near that location
4. Match it to the characteristic whose description AND nominal value best match what you see at that spot
5. Use the matched characteristic's nominal and tolerance exactly as given — do not alter values
6. Each characteristic can only be matched to ONE balloon — do not assign the same characteristic to two balloons
...
NOTES — suggested inspection method:
