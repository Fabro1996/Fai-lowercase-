...
def declutter_balloons(balloons, min_dist=5.0, iterations=40, lo=8, hi=85):
    """
...
Be precise. All {len(extracted["characteristics"])} IDs must be described."""
            ...
            ], max_tokens=1500, model=BALLOON_MODEL, fallback_model=FALLBACK_MODEL)
...
{{"b":[{{"id":1,"matchingText":"95.25","x":38,"y":18}},{{"id":2,"matchingText":"73.03","x":25,"y":55}}]}}"""
        ...
        balloons = declutter_balloons(balloons, min_dist=5.0)
